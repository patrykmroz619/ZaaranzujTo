...
- Store reusable components without business logic in the "ui" folder, in newly added views analyze if there is a potential for reuse some parts of the code and if so, extract them to the "ui" folder.
