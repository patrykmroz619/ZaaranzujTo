...
const features = [
  { icon: Sparkles, titleKey: 'Generuj z AI', descKey: 'Prześlij zdjęcie pokoju lub opisz swoją wizję — AI stworzy profesjonalną wizualizację w kilka minut.' },
  { icon: Palette, titleKey: 'Wybierz styl', descKey: 'Skandynawski, industrialny, boho — wybierz styl i paletę kolorów, które Ci odpowiadają.' },
  { icon: RefreshCw, titleKey: 'Iteruj i udoskonalaj', descKey: 'Modyfikuj wizualizację krok po kroku, aż osiągniesz idealny efekt.' },
];
    ...
    <AppLayout>
      ...
      <section className="relative overflow-hidden gradient-hero">
        <div className="container relative z-10 flex flex-col items-center gap-8 py-20 text-center lg:py-32">
          ...
          >
            Prześlij zdjęcie wnętrza lub opisz je słowami. Sztuczna inteligencja zaprojektuje Twoje wymarzone wnętrze w kilka chwil.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Button size="lg" onClick={() => navigate('/register')} className="gradient-warm text-primary-foreground border-0 gap-2">
              {t('nav.register')}
