        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">{t('settings.deleteAccountConfirm')}</p>
              <Button variant="destructive" size="sm" className="mt-3">{t('settings.deleteAccount')}</Button>
            </div>
          </CardContent>
        </Card>
      </div>
