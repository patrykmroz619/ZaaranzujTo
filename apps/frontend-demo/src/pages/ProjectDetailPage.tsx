...
const mockVisualizations: Record<string, { projectName: string; visualizations: Visualization[] }> = {
  '1': {
    projectName: 'Mieszkanie na Mokotowie',
    visualizations: [
      { id: 'v1', name: 'Salon', iterationCount: 4, latestDate: '2026-03-06' },
      { id: 'v2', name: 'Kuchnia', iterationCount: 2, latestDate: '2026-03-05' },
      { id: 'v3', name: 'Sypialnia', iterationCount: 1, latestDate: '2026-03-03' },
    ],
  },
  '2': {
    projectName: 'Dom w Konstancinie',
    visualizations: [
      { id: 'v4', name: 'Salon z kominkiem', iterationCount: 6, latestDate: '2026-03-04' },
      { id: 'v5', name: 'Gabinet', iterationCount: 3, latestDate: '2026-03-02' },
    ],
  },
...
export default function ProjectDetailPage() {
  ...
  const data = mockVisualizations[projectId || ''] || { projectName: 'Projekt', visualizations: [] };
      ...
      <div className="p-4 md:p-6 lg:p-8 space-y-5">
        ...
        {data.visualizations.length === 0 ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col items-center justify-center py-20 text-center">
            <img src={emptyStateImage} alt="" className="mb-6 h-40 w-40 opacity-80" />
            ...
            <Button onClick={() => navigate(`/workspace/${projectId}/new`)} className="gradient-warm text-primary-foreground border-0 gap-2">
              <Plus className="h-4 w-4" />
              {t('project.emptyCta')}
            </Button>
          </motion.div>
              ...
              >
                ...
                >
                  ...
                  <CardContent className="p-4">
                    <h3 className="font-medium text-card-foreground">{vis.name}</h3>
                    <div className="mt-1 flex justify-between text-xs text-muted-foreground">
                      <span>{vis.iterationCount} {t('project.iterations')}</span>
