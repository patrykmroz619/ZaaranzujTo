...
export const InspirationPhotoField = (props: TInspirationPhotoFieldProps) => {
  ...
  return (
    <div className="space-y-2">
      <Label>{t("workspace.inspirationPhoto")}</Label>
      ...
      {preview ? (
        ...
        <label className="flex h-32 cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border transition-colors hover:border-primary hover:bg-accent/50">
          ...
          <span className="text-sm text-muted-foreground">
            {t("workspace.inspirationPhotoHint")}
          </span>
          <span className="mt-1 text-xs text-muted-foreground">
            {t("workspace.inspirationPhotoSizeHint")}
          </span>
