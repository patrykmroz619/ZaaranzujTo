...
export const SignedUrlResponseSchema = z.object({
  downloadUrl: z.string().url().describe('The pre-signed, temporary URL to securely download the asset'),
  expiresAt: z.string().datetime().describe('The exact ISO timestamp when this URL stops functioning'),
});
